...
const articles = [
  ...
  
    {
      ...
      category:"Music",
      image:"../Images/indila-960x640.jpg",
    },  //music
    {
    id: 9,
    ...
    ` The Latest Triumph: Nadal's Victory in “French Open”
    ...
    ` The Secrets to Nadal's Success: Skill, Strategy, and Grit
    ...
    `,` Nadal's Enduring Legacy: Inspiring Future Generations
  ...
  function renderArticles() {
    ...
    const firstArticle = articles[11]; // Selecting the first article from the array
