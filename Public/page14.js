...
const articles = [
    ...
    `, ` Embracing Cultural Diversity: Sports as a Global Language
    ...
    `, ` Inclusive Sports: Breaking Down Physical and Mental Barriers
  ...
  function renderArticles() {
    ...
    const firstArticle = articles[13]; // Selecting the first article from the array
